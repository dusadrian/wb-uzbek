...
export const editUser = {
    init: async () => {
        ...
        ipcRenderer.on('user', (event, user) => {
            ...
            (<HTMLSelectElement>document.getElementById('name')).value = user.name;
            (<HTMLSelectElement>document.getElementById('patronymics')).value = user.patronymics;
            (<HTMLSelectElement>document.getElementById('surname')).value = user.surname;
            (<HTMLSelectElement>document.getElementById('job_title')).value = user.job_title;
        ...
        (<HTMLButtonElement>document.getElementById('saveForm')).addEventListener('click', () => {
            ...
            const name = (<HTMLSelectElement>document.getElementById('name')).value;
            const patronymics = (<HTMLSelectElement>document.getElementById('patronymics')).value;
            const surname = (<HTMLSelectElement>document.getElementById('surname')).value;

            const job_title = (<HTMLSelectElement>document.getElementById('job_title')).value;
