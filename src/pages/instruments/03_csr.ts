...
export const csr = {
    init: async () => {
        ...
        const table = $('#staff_list').DataTable({
            "language": {
                "url": langpath
            },
...
const fillTable = (table: any, staff: Array<any>) => {
    table.clear().draw();
    staff.forEach((item) => {
        ...
        status.classList.add('justify-end');
